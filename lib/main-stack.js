...
class MainStack extends Stack {
    constructor(scope, id, props) {
        ...
        const valkeyConstruct = new ValkeyConstruct(this, 'Valkey', {
            ...
            allowedIp: process.env.VALKEY_ALLOWED_IP,
        });
        ...
        new CfnOutput(this, 'ValkeyEndpoint', {
            ...
            description: 'Valkey cluster endpoint (internal)',
        ...
        if (valkeyConstruct.publicEndpoint) {
            new CfnOutput(this, 'ValkeyPublicEndpoint', {
                value: valkeyConstruct.publicEndpoint,
                description: 'Valkey public endpoint (via proxy) - use this in Redis Insight',
            });
        }

        new CfnOutput(this, 'SyncTickerBinanceServiceName', {
            value: ecsConstruct.syncTickerBinanceService.serviceName,
            description: 'SyncTicker Binance ECS service name',
        });
        new CfnOutput(this, 'SyncTickerOkxContractServiceName', {
            value: ecsConstruct.syncTickerOkxContractService.serviceName,
            description: 'SyncTicker Okx Contract ECS service name',
        });
        new CfnOutput(this, 'SyncTickerOkxSpotServiceName', {
            value: ecsConstruct.syncTickerOkxSpotService.serviceName,
            description: 'SyncTicker Okx Spot ECS service name',
        });

        new CfnOutput(this, 'fundingRateServiceName', {
            value: ecsConstruct.fundingRateService.serviceName,
            description: 'fundingRateService ECS service name',
        });
    }
}
